...
local mappings = {
	e = {
		...
		f = { ":NvimTreeFindFile<CR>", "Open File Tree With Current File in Focus" },
	},
	f = {
		name = "Search",
		...
		s = { "<cmd>Telescope live_grep<cr>", "Search String with Live Grep" },
	},
	t = {
		name = "Tab",
	...
	T = {
		...
		n = { "<cmd>lua _NODE_TOGGLE()<cr>", "Open Node Terminal" },
	},
	g = {
		name = "Git",
		d = { "<cmd>gs.diffthis<cr>", "show git diff of current buffer" },
		b = { "<cmd>function() gs.blame_line{full=true} end <cr>", "show git blame of current line" },
	},
	s = {
		name = "Split",
		v = { "<C-w>v", "Split vertical" },
		h = { "<C-w>h", "Split horizontal" },
